...
CREATE TABLE `validityperiod` (
  `idvalidityPeriod` int NOT NULL AUTO_INCREMENT,
  `months` int NOT NULL,
  `monthlyFee` int NOT NULL,
  `idPackage` int NOT NULL,
  PRIMARY KEY (`idvalidityPeriod`),
  UNIQUE KEY `idvalidityPeriod_UNIQUE` (`idvalidityPeriod`),
  KEY `idPackage_idx` (`idPackage`),
  CONSTRAINT `idPackagePeriod` FOREIGN KEY (`idPackage`) REFERENCES `package` (`idPackage`)
...
INSERT INTO `validityperiod` VALUES (1,12,20,1),(2,24,18,2),(3,36,15,3),(4,36,13,4),(13,12,20,16),(14,24,17,16),(15,12,30,17),(16,24,20,17),(18,12,10,20),(19,12,10,21);
